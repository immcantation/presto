...
ParseLog.py -l FS[1-2].log -f ID QUALITY
ParseLog.py -l MP[1-2].log -f ID PRIMER BARCODE ERROR
ParseLog.py -l BC[1-2].log -f BARCODE CONSCOUNT PRCONS ERROR
